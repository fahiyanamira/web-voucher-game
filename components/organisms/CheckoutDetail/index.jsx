...
export default function CheckoutDetail() {
  ...
  useEffect(() => {
    ...
    //cek:
    // console.log("data to up local: ", dataTopUpLocal);
  }, []);
  return (
    <>
      <div className="purchase pt-md-50 pt-30">
        ...
        <p className="text-lg color-palette-1 mb-20">
          Price{" "}
          <span className="purchase-details">
            <NumberFormat value={dataTopUp.nominalItem.price} prefix="Rp. " displayType="text" thousandSeparator="." decimalSeparator="," />
          </span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
          Tax (10%){" "}
      ...
      <div className="payment pt-md-50 pb-md-50 pt-10 pb-10">
        ...
        <p className="text-lg color-palette-1 mb-20">
          Your Account Name <span className="purchase-details">{dataTopUp.bankNameAccount}</span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
