      ...
      <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 pb-80">
        <div className="container-fluid">
          <div className="text-center">
            <svg className="img-fluid" width="343" height="300" viewBox="0 0 343 300" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0)">
                <path d="M263.96 271.587C264.986 271.07 265.5 270.554 266.525 270.037" stroke="#FF78B7" strokeWidth="0.6123" strokeLinecap="round" strokeLinejoin="round" />
                <path
                ...
                />
                <path d="M163.407 187.897C164.433 187.897 165.46 187.897 166.486 187.897" stroke="#FF78B7" strokeWidth="0.6123" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M30.5337 294.317H334.245" stroke="#B1B9CC" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M2.8302 294.317H15.1428" stroke="#B1B9CC" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
          ...
          <div className="button-group d-flex flex-column mx-auto">
            ...
            <a className="btn btn-whatsapp fw-medium text-lg color-palette-1 rounded-pill" href="https://wa.me/6282110578704?text=Saya%20sudah%20melakukan%20pembayaran%20topup%20voucher%20game" role="button">
              WhatsApp ke Admin
            </a>
          </div>
        </div>
